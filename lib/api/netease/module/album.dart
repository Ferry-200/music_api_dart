...
Future<Answer> _albumStyle(Map params, List<Cookie> cookie) => _request(
      'POST',
...
Future<Answer> _albumList(Map params, List<Cookie> cookie) => _request(
      'POST',
...
// 全部新碟
//ALL:全部,ZH:华语,EA:欧美,KR:韩国,JP:日本
Future<Answer> _albumNew(Map params, List<Cookie> cookie) => _request(
      'POST',
